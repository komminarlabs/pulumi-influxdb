...
namespace KomminarLabs.InfluxDB
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/komminarlabs";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("KomminarLabs.InfluxDB.version.txt");
    ...
    internal sealed class InfluxDBResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public InfluxDBResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}

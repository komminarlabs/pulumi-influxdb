...
class GetOrganizationsResult:
    ...
    """
    def __init__(__self__, id=None, organizations=None):
...
def get_organizations(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetOrganizationsResult:
    ...
    __ret__ = pulumi.runtime.invoke('influxdb:index/getOrganizations:getOrganizations', __args__, opts=opts, typ=GetOrganizationsResult).value
...
def get_organizations_output(opts: Optional[Union[pulumi.InvokeOptions, pulumi.InvokeOutputOptions]] = None) -> pulumi.Output[GetOrganizationsResult]:
    ...
    __ret__ = pulumi.runtime.invoke_output('influxdb:index/getOrganizations:getOrganizations', __args__, opts=opts, typ=GetOrganizationsResult)
